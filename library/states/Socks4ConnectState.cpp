...
void Socks4ConnectState::handleDomainLookupResult(const QHostInfo &info)
{
    ...
    QHostAddress result = info.addresses()[QRandomGenerator::global()->generate() % info.addresses().size()];
...
void Socks4ConnectState::handleIP()
{
    ...
    connect(_socket,
            ...
            this,
            &Socks4ConnectState::handleSocketConnected);
    connect(_socket,
            &QTcpSocket::errorOccurred,
            this,
            &Socks4ConnectState::handleSocketError);
...
void Socks4ConnectState::handleDomain()
{
    ...
    _dnsLookupID = QHostInfo::lookupHost(_request->domainName(),
                                         this,
                                         &Socks4ConnectState::handleDomainLookupResult);
}
