...
void Socks5ConnectState::handleDomainLookupResult(const QHostInfo &info)
{
    ...
    QHostAddress chosen = info.addresses()[QRandomGenerator::global()->generate() % info.addresses().size()];
...
void Socks5ConnectState::handleIP()
{
    ...
    connect(_socket,
            ...
            this,
            &Socks5ConnectState::handleSocketConnected);
    connect(_socket,
            &QTcpSocket::errorOccurred,
            this,
            &Socks5ConnectState::handleSocketError);
...
void Socks5ConnectState::handleDomain()
{
    ...
    _dnsLookupID = QHostInfo::lookupHost(_request->domainName(),
                                         this,
                                         &Socks5ConnectState::handleDomainLookupResult);
}
